...
export const setupMocks = () => {
    ...
    const windowMock = {
        kubectl: {
            ...
            onPortForwardReady: vi.fn((_id: string, _cb: (...args: any[]) => void) => vi.fn()),
            onPortForwardError: vi.fn((_id: string, _cb: (...args: any[]) => void) => vi.fn()),
            onPortForwardExit: vi.fn((_id: string, _cb: (...args: any[]) => void) => vi.fn()),
